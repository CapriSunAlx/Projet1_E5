...
<body>
	...
	<form method="POST" action="include/calculer_mention.php">
            <p>Votre nom : <input type="text" name="nom" required placeholder="Votre nom">
		</p>                   
            <p>Votre prénom : <input type="text" name="prenom" required placeholder="Votre prénom">
		</p>
            <p>Votre note : <input type="number" name="note" required placeholder="Votre note">
		</p>
